...
import { midtransConfig } from './midtrans.js';
const APP_PREFIX = {
...
export async function createPayment(params) {
    ...
    try {
        ...
        if (params.paymentMethod === 'CREDIT_CARD' && params.enableAutoRenewal) {
            const subscription = await midtrans.createSubscription(user.name, user.email, params.paymentProvider, amount, orderId);
...
export async function handleMidtransCallback(orderId, status, transactionId, callbackData) {
