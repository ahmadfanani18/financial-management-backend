...
import { getGoalsHandler, getGoalsOverviewHandler, getGoalHandler, createGoalHandler, updateGoalHandler, deleteGoalHandler, addContributionHandler, toggleLockHandler, deleteGoalWithTransactionHandler, getContributionsHandler, addContributionWithAccountHandler, createGoalFromMilestoneHandler, deleteGoalWithRefundHandler, deleteContributionHandler, } from './controller.js';
export async function goalRoutes(fastify) {
